        ...
        <v-card color="rgb(255, 255, 255, 0.7)" class="container mb-10">
            <div class="mx-5 my-5 font-weight-black">
                ...
                <v-row>
                    ...
                    <v-col cols="5">
                        <v-row>
                            <v-col v-if="!!submitData.tags">
                                <v-row>
                                    <v-col v-for="(tag, i) in submitData.tags" :key="tag.id" cols="auto" class="ma-0">
                                        <v-chip
                                            v-if="!!submitData.tags[i]"
                                            class="mr-1"
                                            close
                                            color="red"
                                            text-color="white"
                            ...
                            <div>
                                <div v-for="(tag, index) in autocompletelist" :key="index">
                                    <p>{{ tag }} <button @click="appendTag(tag)">추가</button></p>
                                </div>
                            </div> -->
                        </v-row>
                    </v-col>
...
export default {
    ...
    components: {
        ...
        Schedule: () => import('@/components/base/Schedule'),
    },
    methods: {
        onClickImageUpload() {
